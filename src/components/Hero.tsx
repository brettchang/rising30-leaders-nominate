...
const Hero = () => {
  return <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white font-glacial">
        ...
        <div className="mb-8">
          <img src="/lovable-uploads/bb8b9c79-9aee-4402-97d9-2de36bbf8974.png" alt="Canadian Parliament Building" className="mx-auto h-52 md:h-64 w-auto" />
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-3 mb-8">
          <div className="flex items-center gap-3">
            ...
            <img src="/lovable-uploads/0614deca-3570-4999-8688-929b81ac3f07.png" alt="The Peak logo" className="h-12 w-auto" />
          </div>
          <div className="flex items-center gap-2">
            <span className="text-xl text-black font-glacial font-bold">Supported by</span>
            <img src="/lovable-uploads/acc7899c-082c-4839-95e5-c9d8f3020c75.png" alt="Page logo" className="h-10 w-auto" />
          </div>
        </div>
        
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <Button variant="default" size="lg" className="text-lg px-8 py-4 h-auto text-white !bg-[#418476] hover:!bg-[#367066] !bg-none" asChild>
      ...
      {/* Scroll Indicator */}
      <div className="absolute bottom-4 md:bottom-6 left-1/2 transform -translate-x-1/2 text-black animate-bounce">
